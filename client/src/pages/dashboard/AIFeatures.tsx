              ...
              <CardContent>
                {results.booking ? (
                  <div className="space-y-4">
                    ...
                    {results.booking.recommendations?.map((rec: any, idx: number) => (
                      <div key={idx} className="border rounded-lg p-3 space-y-2">
                        <div className="flex items-center justify-between">
                          <span className="font-medium">Rank #{rec.rank}</span>
                        ...
                        <div className="flex gap-2">
                          ...
                          <Badge variant="outline">{rec.valueRating}</Badge>
                        </div>
                      </div>
                ...
                {results.agent ? (
                  <div className="space-y-4">
                    ...
                    <div className="text-xs text-muted-foreground">
                      Executed at: {new Date(results.agent.executedAt).toLocaleString()}
                    </div>
                  </div>
                ) : (
