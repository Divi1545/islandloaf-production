...
interface DashboardData {
  ...
  bookingSources: Array<{ name: string; percentage: number; color: string }>;
  stats: {
    totalRevenue: string;
    bookings: string;
    avgRating: string;
    ...
    return (
      <div className="space-y-6">
        ...
        <Alert>
          ...
          <AlertDescription>Dashboard data is not available at the moment.</AlertDescription>
        </Alert>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard 
          ...
          trend={dashboardData.stats.conversionTrend}
          subtitle="vs. last month"
        />
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <ServiceBreakdown services={dashboardData.serviceTypes} />
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <BookingSources sources={dashboardData.bookingSources} />
          </CardContent>
        </Card>
      </div>
