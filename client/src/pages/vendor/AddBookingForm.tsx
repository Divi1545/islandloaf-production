  ...
  useEffect(() => {
    ...
    const fetchServices = async () => {
      try {
        ...
        setServices(data.filter((service: any) => service.type === bookingType));
      } catch (error) {
        ...
        if (bookingType === 'stay') {
          try {
            ...
            if (stayTypesResponse.ok) {
              ...
              // Use default stay types if API fails
              setStayTypes([]);
            }
            ...
            if (propertyTypesResponse.ok) {
              ...
              // Use default property types if API fails
              setPropertyTypes([]);
            }
            ...
            if (propertySpacesResponse.ok) {
              ...
              // Use default property spaces if API fails
              setPropertySpaces([]);
            }
            ...
            if (amenitiesResponse.ok) {
              ...
              // Use default amenities if API fails
              setAmenities([]);
            }
          } catch (error) {
          ...
          try {
            ...
            if (rentalTypesResponse.ok) {
              ...
              // Use default rental types if API fails
              setRentalTypes([]);
            }
            ...
            if (fuelTypesResponse.ok) {
              ...
              // Use default fuel types if API fails
              setFuelTypes([]);
            }
            ...
            if (transmissionsResponse.ok) {
              ...
              // Use default transmissions if API fails
              setTransmissions([]);
            }
            ...
            if (vehicleAddonsResponse.ok) {
              ...
              // Use default vehicle addons if API fails
              setVehicleAddons([]);
            }
          } catch (error) {
